...
PROFILES = {
    ...
    "Windows": [
        ...
        Link("komorebi", "confs/win/komorebi.json", f"{KOMORBI_CONFIG_HOME}/komorebi.json"),
        Link("komorebi-ahk", "confs/win/komorebi.ahk", f"{KOMORBI_CONFIG_HOME}/komorebi.ahk"),
        Link("kanata", "confs/kanata.kbd", f"{MISC_CONFIG_HOME}/kanata.kbd"),   
        InstallPwshProfile("win-pwsh-profile",
            "confs/win/profile.ps1"
        ),
